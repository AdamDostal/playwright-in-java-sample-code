package framework.tests.purchase;

import framework.api.models.User;
import framework.fixtures.BaseTest;
import framework.pages.catalog.ProductDetails;
import framework.pages.catalog.ProductList;
import framework.pages.catalog.SearchComponent;
import framework.pages.catalog.ShoppingCart;
import framework.pages.catalog.workflow.Authentication;
import framework.pages.catalog.workflow.Purchase;
import framework.pages.common.NavBar;
